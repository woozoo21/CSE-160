...
class Vector3 {
    ...
    static dot(other1, other2) {
      ...
      var d = other1.elements, c = other2.elements; // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
    ...
    static cross(other1, other2) {
        var x = other1.elements, y = other2.elements;
        return new Vector3([
          x[1]*y[2] - x[2]*y[1], 
          x[2]*y[0] - x[0]*y[2], 
          x[0]*y[1] - x[1]*y[0]]); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
    }
